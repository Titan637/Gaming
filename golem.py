...
TOKEN = '7888977015:AAG9zrTsJKD5G8mL1lvEosd-go4VrCzkDoo'
MONGO_URI = 'mongodb+srv://Bishal:Bishal@bishal.dffybpx.mongodb.net/?retryWrites=true&w=majority&appName=Bishal'
FORWARD_CHANNEL_ID = -1002374253353
CHANNEL_ID = -1002374253353
error_channel_id = -1002374253353
    ...
    try:
        ...
        if not user_data or user_data['plan'] == 0:
            bot.send_message(chat_id, "*🚫 ACCESS DENIED!*\n"  # Access Denied message
                                       ...
                                       "*Contact the owner for assistance: @VILAXLORD*", parse_mode='Markdown')  # Contact owner message
            return
        ...
        bot.send_message(chat_id, "*💣 Ready To Launch An Attack?*\n"  # Ready to launch message
                                   ...
                                   "*OWNER @VILAXLORD🧛*", parse_mode='Markdown')  # Start chaos message
...
def process_attack_command(message):
    try:
        ...
        if target_port in blocked_ports:
            ...
            return
        if duration >= 301:
            bot.send_message(message.chat.id, "*⏳ Maximum duration is 301 seconds.*\n"  # Duration limit message
        ...
        bot.send_message(message.chat.id, f"*🚀 Attack Launched! 🚀*\n\n"  # Attack launched message
                                           ...
                                           f"*⏰ TIME<>{duration} seconds send feedback to @VILAXLORD🔥*", parse_mode='Markdown')  # Duration message
...
def myinfo_command(message):
    ...
    if not user_data:
        ...
        response += "*For assistance, please contact the owner: @VILAXLORD* "  # Contact owner message
    elif user_data.get('plan', 0) == 0:
        # User found but not approved
        response = "*🔒 Your account is still pending approval!* \n"  # Not approved message
        response += "*Please reach out to the owner for assistance: @VILAXLORD 🙏"  # Contact owner message
    else:
...
def rules_command(message):
    rules_text = (
        ...
        "2. Limit your kills! 🔫 \nStay under 25-30 kills to keep it fair.\n\n"
